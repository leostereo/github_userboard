    ...
    <div class="flex-items">
      <div class="find">
        ...
        <input
          type="text"
          class="searchTerm"
          v-model="searchString.user_find"
        />
      </div>
    </div>
  </div>
